// bubble-renderer.js — Fixed Telegram-style bubbles + mask tail + avatars always visible
(function(){
  'use strict';
  ...
  function init(){
    ...
    function createBubbleElement(persona, text, opts={}){
      ...
      // assemble — avatars always visible, tail via CSS
      if(type==='incoming'){
    ...
    console.log('bubble-renderer fully fixed — avatars visible, correct mask tail');
  }
