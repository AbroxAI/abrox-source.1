// bubble-renderer.js — Telegram 2026 fully patched with captions, opacity, sender & joiner
(function(){
  'use strict';
  ...
  function init(){
    ...
    function createBubbleElement(persona, text, opts={}){
      ...
      // Right-click context for auto-reply
