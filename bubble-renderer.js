// bubble-renderer-fixed.js — Telegram 2026 Bubble Renderer + New Message Pill
(function(){
  'use strict';
  ...
  function init() {
    ...
    console.log('bubble-renderer fixed & integrated with new message pill');
  }
