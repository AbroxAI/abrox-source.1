...
document.addEventListener("DOMContentLoaded", () => {
  ...
  style.textContent = `
    .tg-highlight {
      ...
      border-radius: 14px;
      animation: tgFadePulse 2.6s cubic-bezier(.4,0,.2,1) forwards;
    }
  ...
  document.addEventListener("messageAppended", (ev) => {
    ...
    // remove typing once persona sends a message
  ...
  function attachReplyJump(newMessageId, replyText) {
    ...
    replyPreview.addEventListener('click', () => {
      ...
      // Prefer MESSAGE_MAP if available for accurate jumps
...
✅ To verify or contact admin, use the Contact Admin button below.`;
  ...
  function showPinBanner(image, caption, pinnedMessageId) {
    ...
    text.textContent = caption || "Pinned message"; // keep old neat spacing
  ...
  console.log("✅ app.js patched: header typing fixed, reply preview jumps, Telegram-style pulse, pin banner intact");
