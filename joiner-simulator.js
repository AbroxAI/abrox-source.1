// joiner-simulator.js — Telegram 2026 updated for full integration with bubbles & realism engine
(function(){
  ...
  const WELCOME_TEXT_POOL = [
    ...
    "Hi all, hope to learn something new today 😎","Hey team! Ready to grow together 💪",
    "Good to be here! Looking forward to insights 📈","Glad to be part of this community 🌟",
    "Hello traders! Let's make this a profitable journey 💸","Hi everyone, excited to follow trends 📊",
    "Hey all, ready to share ideas and strategies 🧠","Happy to connect with like-minded people 🤝",
    "Ready to follow the signals and grow 💹","Excited to trade with you all 🚀","Hi, looking forward to collaborative learning ✨",
    "Hello, let's make some smart moves together 📊","Glad to join this awesome group 😎",
    "Hi team, here to learn and contribute 🎯","Happy to meet everyone, excited to start 💡",
    "Hello traders, looking forward to profitable trades 🏆","Excited to be on board and learn daily 📈",
    "Hi, hoping to gain valuable insights 💹","Hey, let's make consistent profits together 💰",
    "Glad to be here, looking forward to signals 🔥","Hello everyone, excited to start trading 💸",
    "Hi, hoping to improve my trading skills 📊","Hey all, looking forward to a great experience 🚀",
    "Happy to be part of this community 🌟","Hello team, ready to grow and learn together 🧠",
    "Hi everyone, excited to follow trends and signals 📈","Glad to join, ready to trade smart 💹",
    "Hey, looking forward to learning new strategies ✨","Hi team, excited for collaborative trading 🤝",
    "Hello, happy to join and contribute ideas 💡","Hi all, ready for profitable trading sessions 🔥",
    "Hello traders, let's make the most of this group 🚀"
  ];
  ...
  function uniqueNameCandidate(base){
    ...
    while(usedJoinNames.has(candidate) && guard<12){
      candidate = `${base}_${randInt(1000,9999)}`;
      guard++;
    }
  ...
  function postWelcomeAsBubbles(joiner){
    ...
    setTimeout(()=>{
      ...
      if(window.realismEngineV11Pool){
        const replyCount = 1+randInt(0,2);
